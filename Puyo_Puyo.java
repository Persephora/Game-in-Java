...
/**
 * Clase Puyo_Puyo
 * L'empra el projecte per inicialitzar el programa
 * Empra cinc variables.
 * @see #gp
 * @see #width
 * @see #height
 * @see #rows
 ...
 * @see #main(String[])
 * @see #Puyo_Puyo()
 * @see #initgame(int, int)
 * @see #prepareMove(int)
 */
public class Puyo_Puyo extends JFrame {
    /**
     *Conte el taulell de joc
     */
    public GamePane gp;
    //GamePane is subclass of JComponent on which the puyos are moved
    /**
     * width : amplada del taulell
     * height: altura del taulell
     */
    private int width, height;
    /**
     *  rows: numero de files del taulell
     *  cols: numero de columnes del taulell
     */
    private int rows, cols;
    /**
     *  puyo_len: longitud del taulell
     */
    int puyo_len;            //holds the length of the each puyo(because it is a square piece)
    /**
     *  screenSize: tamany de la pantalla del jugador.
     */
     ...
     * prepareMove
     *prepara un moviment
     * @param m acepta com a parametre una posicio
     * @return Retorna la posicio relativa a la pantalla de l'usuari
     */
    ...
    /**
     * initgame
     * metode que s'encarrega unicament d'inicialitzar el taulell amb els possibles moviments que es poden realitzar
     * @param rows Numero de files
     * @param cols Numero de columnes
     * @return Retorna TRUE si s'ha pgut inicialitzar, sino FALSE
     */
    ...
    /**
     * Puyo_Puyo
     * constructor  encarregat d'inicialitzar tot l'entorn de joc.
     * El panell adaptar a l'ample i alt de l'usuari.
     */
    public Puyo_Puyo() {
        super("Puyo_Puyo");
    ...
    /**
     * main
     * Metode inicial del projecte GameInJava
     * @param args Acepta un array de Strings, pero aquest parametre no s'empra dins el projecte
     */
...
class GamePane extends JComponent implements ActionListener {
    ...
    //METODOS TOSTRING CLASS GAMEPANE
    @Override
    ...
    //METODOS EQUAL CLASS GAMEPANE
    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;

        GamePane gamePane = (GamePane) o;
        ...
        if (!Arrays.equals(img, gamePane.img)) return false;
        ...
        // Probably incorrect - comparing Object[] arrays with Arrays.equals
        if (!Arrays.equals(files, gamePane.files)) return false;
        // Probably incorrect - comparing Object[] arrays with Arrays.equals
        if (!Arrays.equals(clips, gamePane.clips)) return false;
    ...
    //GETTERS AND SETTERS CLASS GAMEPANE
